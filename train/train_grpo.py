...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-name-or-path", type=str, default="outputs/sft/qwen2p5_7b/final")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("outputs/grpo/qwen2p5_7b"))
...
def main() -> None:
    ...
    logger("2. Load GRPO prompt datasets")
